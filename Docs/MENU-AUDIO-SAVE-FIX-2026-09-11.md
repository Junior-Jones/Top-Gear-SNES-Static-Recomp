...
Reproduction sources, WAV comparisons, CSV timing/audio diagnostics, and original source backups are in ../../../../Title-Check-2026-09-11 relative to this receipt folder (absolute location: D:/Users/build/retro/Recomp/Top Gear/Temp/Title-Check-2026-09-11). Use voice-live.c and CMake target voice-live with ROM, output CSV, and final argument 1 for old synchronous save or 0 for background save. The valid playback evidence is live-playing-before.csv and live-playing-after.csv; preliminary live-before.csv/live-after.csv did not resume the device and are not playback evidence.
