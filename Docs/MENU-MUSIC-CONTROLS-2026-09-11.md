...
Harness source, logs and screenshots: D:/Users/build/retro/Recomp/Top Gear/Temp/Title-Check-2026-09-11/volume.c, volume-race.c, volume-events.csv, volume-race.csv, volume-*.png. Test files use isolated Temp outputs and never write user Data. Earlier failed race-trigger probes are superseded by the common-bus hook result.
