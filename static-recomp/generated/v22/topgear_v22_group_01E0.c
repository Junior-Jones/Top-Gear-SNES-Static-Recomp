...
int tg_v22_group_01E0(struct TopGearRecomp *instance){
    ...
    case 0x00078006u: /* AA TAX */
        ...
        instance->instruction_count++;
        return 1;
    case 0x00078007u: /* BD 64 81 LDA $8164,X */
    ...
    case 0x04078025u: /* C2 20 REP #$20 */
        ...
        instance->instruction_count++;
        return 1;
    case 0x00078027u: /* A9 AA BB LDA #$BBAA */
        word = 0xBBAAu;
        tg_set_acc16(instance, word);
        tg_set_nz16(instance, word);
        ...
        instance->instruction_count++;
        return 1;
    case 0x0007802Au: /* CD 40 21 CMP $2140 */
        if (!tg_bus_read16(instance, (((uint32_t)instance->cpu.dbr << 16) | 0x2140u), &word)) return 0;
        tg_compare16(instance, instance->cpu.a, word);
        instance->cpu.pc = 0x802Du;
        instance->instruction_count++;
        return 1;
    case 0x0007802Du: /* D0 FB BNE $07:802A */
        instance->cpu.pc = !tg_flag(instance, TG_P_Z) ? 0x802Au : 0x802Fu;
        instance->instruction_count++;
        return 1;
